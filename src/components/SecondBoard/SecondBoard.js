...
//     dataNj = dataNj.reshape(kDepthNum, pointNum, 4);
//
//
...
//           yAxisIndex: 0,
//           symbol: 'rect',
//           symbolSize: [symbolSizeWidth, symbolSizeHeight],
//
//           itemStyle: {
//             opacity: 0.9,
//             borderWidth: 0,
      ...
      <ReactEcharts id='filter'
                    ...
                    ref={(e) => {
                      if (e) {
                        ...
                        //   text:'Rendering'
                        // });
                        // secondEchartInstance.on('finished', ()=> {
                        //   secondEchartInstance.hideLoading();
                        //   secondEchartInstance.off('finished');
                        // });
                      }
                    }}
      />
